...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _login(BuildContext context) async {
    ...
    if (phone.isEmpty) {
      showCustomSnackBarHelper('please_give_your_phone_number'.tr,
          isError: true);
      ...
      try {
        await Get.find<AuthController>().setUserData(
            UserShortDataModel(phone: phone, countryCode: _countryCode));
        ...
        showCustomSnackBarHelper('please_input_your_valid_number'.tr,
            isError: true);
      }
    }
  }
